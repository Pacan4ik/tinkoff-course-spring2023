...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    /**
     * The column <code>LINK.ADDITIONAL_INFO</code>.
     */
    public final TableField<LinkRecord, JSON> ADDITIONAL_INFO = createField(DSL.name("ADDITIONAL_INFO"), SQLDataType.JSON.defaultValue(DSL.field(DSL.raw("JSON '\"{}\"'"), SQLDataType.JSON)), this, "");
    ...
    @Override
    @NotNull
    public Row6<Long, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, JSON> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? super JSON, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? super JSON, ? extends U> from) {
