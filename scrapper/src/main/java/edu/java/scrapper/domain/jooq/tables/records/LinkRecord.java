...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record6<Long, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, JSON> {
    ...
    @Override
    @NotNull
    public Row6<Long, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, JSON> valuesRow() {
    ...
    @Override
    @NotNull
    public LinkRecord value6(@Nullable JSON value) {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @Nullable OffsetDateTime value3, @Nullable OffsetDateTime value4, @Nullable OffsetDateTime value5, @Nullable JSON value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable OffsetDateTime updatedAt, @Nullable OffsetDateTime createdAt, @Nullable OffsetDateTime checkedAt, @Nullable JSON additionalInfo) {
        super(Link.LINK);
