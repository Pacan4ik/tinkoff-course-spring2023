...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record7<Long, String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, JSON> {
     ...
     */
    public void setEventDescription(@Nullable String value) {
        set(2, value);
    }
    ...
    @Override
    @NotNull
    public Row7<Long, String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, JSON> valuesRow() {
    ...
    public Field<String> field3() {
        return Link.LINK.EVENT_DESCRIPTION;
    }
    ...
    @Override
    @NotNull
    public LinkRecord value7(@Nullable JSON value) {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @Nullable String value3, @Nullable OffsetDateTime value4, @Nullable OffsetDateTime value5, @Nullable OffsetDateTime value6, @Nullable JSON value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable String eventDescription, @Nullable OffsetDateTime updatedAt, @Nullable OffsetDateTime createdAt, @Nullable OffsetDateTime checkedAt, @Nullable JSON additionalInfo) {
        super(Link.LINK);
