...
public class DefaultSchema extends SchemaImpl {
    ...
    /**
     * The table <code>LINK_CHAT_ASSIGNMENT</code>.
     */
    public final LinkChatAssignment LINK_CHAT_ASSIGNMENT = LinkChatAssignment.LINK_CHAT_ASSIGNMENT;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.asList(
            Chat.CHAT,
            Link.LINK,
            LinkChatAssignment.LINK_CHAT_ASSIGNMENT
        );
    }
}
