...
@SpringBootTest
@TestPropertySource(properties = "app.data-base-access-type=jooq")
public class JooqLinkInfoAdapterTest extends IntegrationTest {
    ...
    void shouldReturnCorrectObject() {
        ...
        System.out.println(linkInfoDto);
